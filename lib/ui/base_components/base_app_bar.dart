...
class BaseAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final double? bottomWidgetHeight, titleSize;
  final FontWeight? fontWeight;
  const BaseAppBar({super.key, this.title, this.onBackPressed, this.showNotification, this.showDrawerIcon, this.bottomChild, this.bottomWidgetHeight, this.contentColor, this.titleSize, this.fontWeight});
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      titleSpacing: (showDrawerIcon??false) ? 0 : null,
      elevation: 0.0,
